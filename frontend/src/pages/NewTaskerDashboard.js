            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-center">
              ...
              <div className="lg:col-span-2 space-y-4">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                  ...
                  {/* Rating - Not clickable, just display */}
                  <div className="bg-white/20 backdrop-blur-md rounded-xl p-3 border border-white/30 text-left">
                    <div className="flex items-center space-x-2 mb-1">
                  ...
                  {/* Reviews - Click to see reviews page */}
                  <button
                    onClick={() => navigate('/tasker/reviews')}
                    className="bg-white/20 backdrop-blur-md rounded-xl p-3 border border-white/30 transform hover:scale-105 transition-all duration-300 hover:bg-white/30 text-left cursor-pointer"
                  >
                    <div className="flex items-center space-x-2 mb-1">
