...
const ChatModal = ({ isOpen, onClose, task, currentUser, otherUser, language = 'en' }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white dark:bg-gray-800/70 rounded-lg shadow-xl max-w-2xl w-full h-[600px] flex flex-col">
        {/* Header */}
        ...
        {/* Task Info */}
        <div className="px-4 py-2 bg-gray-50 dark:bg-gray-950 border-b">
                  ...
                  <div
                    className={`max-w-[70%] rounded-lg px-4 py-2 ${
                      isOwnMessage
                        ...
                        : 'bg-white text-gray-800 dark:text-gray-100 border border-gray-200'
                    }`}
                  >
        ...
        {/* Input */}
        <div className="p-4 border-t bg-white dark:bg-gray-800/70">
