...
export const SkeletonCard = () => (
  <div className="bg-white dark:bg-gray-800/70 rounded-xl shadow-md p-6 animate-pulse">
...
export const SkeletonList = ({ count = 3 }) => (
  <div className="space-y-4">
    {[...Array(count)].map((_, i) => (
      <div key={i} className="bg-white dark:bg-gray-800/70 rounded-lg shadow-md p-4 animate-pulse">
...
export const SkeletonTable = ({ rows = 5, cols = 4 }) => (
  <div className="bg-white dark:bg-gray-800/70 rounded-xl shadow-md overflow-hidden">
    <div className="animate-pulse">
      {/* Header */}
      <div className="bg-gray-50 dark:bg-gray-950 px-6 py-4 border-b border-gray-200">
...
export const SkeletonProfile = () => (
  <div className="bg-white dark:bg-gray-800/70 rounded-xl shadow-md p-8 animate-pulse">
